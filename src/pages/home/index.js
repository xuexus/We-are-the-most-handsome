    ...
    render() {
        ...
        return (
            <Home>
                ...
                {/* 头部的搜索框及分类 */}
                <div className="home_first" style={{ background: this.state.color ? "white" : "" }}>
                    <div className="home_first-one">
                        <div className="home_first-one_one">
                            <p className="home_first_one_one_one">请输入搜索内容</p>
                        </div>
                            ...
                            <ul className="home_first_two_one_one">
                                {
                                    (mes.navs ? mes.navs.menus.data : []).map((item, index) => {
                                        return <li key={index} className="home_first_two_one_one_one">
                                            {item.name}
                                        </li>
                                    })
                                }
                ...
                <div className="matter" onScroll={this.handleOnScroll.bind(this)}>
                    {/* 首页的轮播 */}
                    <div className="home">
                        <WingBlank>
                            <Carousel
